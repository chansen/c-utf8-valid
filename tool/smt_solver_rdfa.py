#!/usr/bin/env python3
# Derives state offsets and transition row values for the 32-bit reversed
# UTF-8 validation DFA encoded in utf8_rdfa32.h.
#
# The DFA has 7 states. Each state is assigned a bit offset within a
...
STATE_NAMES = [
    'S_ERROR', 'S_ACCEPT', 'S_TL1', 'S_TL2LO', 'S_TL2HI', 'S_TL3LO', 'S_TL3MH',
]
...
TRANSITIONS = [
    (ERR, S_ACCEPT, ERR,      ERR,      ERR,      ERR,      ERR      ),  # ASCII
    (ERR, ERR,      S_ACCEPT, ERR,      ERR,      ERR,      ERR      ),  # C2-DF
    (ERR, ERR,      ERR,      S_ACCEPT, S_ACCEPT, ERR,      ERR      ),  # E1-EC, EE-EF
    (ERR, ERR,      ERR,      ERR,      ERR,      S_ACCEPT, S_ACCEPT ),  # F1-F3
    (ERR, S_TL1,    S_TL2LO,  S_TL3LO,  S_TL3LO,  ERR,      ERR      ),  # 80-8F    
    (ERR, S_TL1,    S_TL2LO,  S_TL3MH,  S_TL3MH,  ERR,      ERR      ),  # 90-9F
    (ERR, S_TL1,    S_TL2HI,  S_TL3MH,  S_TL3MH,  ERR,      ERR      ),  # A0-BF
    (ERR, ERR,      ERR,      ERR,      S_ACCEPT, ERR,      ERR      ),  # E0
    (ERR, ERR,      ERR,      S_ACCEPT, ERR,      ERR,      ERR      ),  # ED
    (ERR, ERR,      ERR,      ERR,      ERR,      ERR,      S_ACCEPT ),  # F0
    (ERR, ERR,      ERR,      ERR,      ERR,      S_ACCEPT, ERR,     ),  # F4
    (ERR, ERR,      ERR,      ERR,      ERR,      ERR,      ERR,     ),  # ERROR  C0-C1, F5-FF
]
