...
STATE_NAMES = [
    'S_ERROR', 'S_ACCEPT', 'S_TAIL1', 'S_TAIL2', 'S_TAIL3',
    'S_E0', 'S_ED', 'S_F0', 'S_F4',
]
...
TRANSITIONS = [
    ...
    (ERR, S_TAIL3,  ERR,     ERR,     ERR,     ERR,     ERR,     ERR,     ERR    ),  # F1-F3
    (ERR, ERR,      S_ACCEPT,S_TAIL1, S_TAIL2, ERR,     S_TAIL1, ERR,     S_TAIL2),  # 80-8F
    (ERR, ERR,      S_ACCEPT,S_TAIL1, S_TAIL2, ERR,     S_TAIL1, S_TAIL2, ERR    ),  # 90-9F
    (ERR, ERR,      S_ACCEPT,S_TAIL1, S_TAIL2, S_TAIL1, ERR,     S_TAIL2, ERR    ),  # A0-BF
